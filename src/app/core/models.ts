 ...
 * припоминание заметно труднее узнавания, и уверенно узнаваемое слово
 * активно вспоминается далеко не всегда.
 */
export type Skill = 'translation' | 'recall' | 'article' | 'verb';
